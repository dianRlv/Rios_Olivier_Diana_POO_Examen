...
Descripción General del Script: Codigo por medio del cual la IA creada para el enemigo, es capas de perseguir continuamente
                                al jugador (player), activando las animaciones de idle, run, basado en las condiciones que se 
                                cumplen y estan especificadas en el codigo.
